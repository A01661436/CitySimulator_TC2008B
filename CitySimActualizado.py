...
class TrafficLightAgent(Agent):
    ...
    def step(self):
        # El cambio de estado se maneja en IntersectionController
        pass
...
def agent_portrayal(agent):
    if isinstance(agent, Car):
        ...
        # Actualizar el color en función del estado del semáforo
        if agent.state == 'red':
            color = "red"
        elif agent.state == 'green':
            color = "green"
        elif agent.state == 'yellow':
            color = "yellow"  # Asegúrate de agregar el color para el estado 'amarillo'
